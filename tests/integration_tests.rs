...
fn test_full_config_workflow() {
    ...
    assert_eq!(
        loaded_config.env.get("NODE_ENV"),
...
fn test_config_with_complex_routes() {
    ...
    processes.insert(
        ...
        ProcessConfig {
            ...
            port: Some(5001),
            routes: vec!["/api/v1/*".to_string(), "/v1/*".to_string()],
    ...
    processes.insert(
        ...
        ProcessConfig {
            ...
            port: Some(5002),
            routes: vec!["/api/v2/*".to_string(), "/v2/*".to_string()],
...
"#;
    ...
    let config = RealmConfig {
        env: HashMap::from([("INLINE_VAR".to_string(), "inline_value".to_string())]),
    ...
    assert_eq!(
        loaded_config.env.get("INLINE_VAR"),
